          ...
          <div className="lg:pr-8">
            ...
            <div className="mt-6 px-4 py-3 bg-gray-50 border-r-4 border-[#940066] rounded-lg shadow-sm">
              <p className="text-gray-700 text-lg leading-relaxed italic">
                "التعليم هو الجسر الذي يعبر عليه الطلبة نحو مستقبل أفضل، وهو النور الذي يبدد ظلام الحاجة والعوز."
              </p>
            </div>

            <p className="mt-6 text-gray-700 text-lg leading-relaxed">
              في <strong>أرومة</strong>، نؤمن أن كل طالب لديه حلم، ولكن ليس الجميع يملكون الفرصة لتحقيقه. 🎓  
              نحن <strong>منصة خيرية</strong> تهدف إلى <strong>جمع التبرعات</strong> لتغطية تكاليف التعليم الجامعي للطلبة غير المقتدرين، لنمنحهم فرصة استكمال دراستهم وبناء مستقبلهم.
            </p>

            <p className="mt-4 text-gray-700 text-lg leading-relaxed">
              عندما تتبرع، فأنت لا تقدم مساعدة فقط، بل <strong>تستثمر في مستقبل واعد</strong>.  
              كل مساهمة تحدث فرقًا حقيقيًا، فقد تكون سببًا في تحويل طالب اليوم إلى قائد الغد! 🌟
            </p>

            <p className="mt-4 text-gray-700 text-lg leading-relaxed font-semibold">
              💜 لا تدع الأحلام تتوقف بسبب قلة الموارد! ساهم الآن في بناء مستقبل مشرق وكن جزءًا من رحلة العطاء والتغيير.
            </p>
