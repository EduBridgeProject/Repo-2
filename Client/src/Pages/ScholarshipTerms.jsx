...
const ScholarshipTerms = () => {
  return (
    <div className="bg-gradient-to-b from-purple-50 to-gray-100 min-h-screen p-6">
      {/* Container */}
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-lg border-t-4 border-purple-700">
        {/* Header with decorative elements */}
        <div className="relative text-center mb-8">
          <div className="absolute left-0 right-0 h-px bg-gradient-to-r from-transparent via-purple-300 to-transparent"></div>
          <h1 className="text-3xl font-bold text-center text-purple-800 my-6 relative inline-block">
            <span className="relative z-10">✨ شروط الحصول على المنحة الجامعية 🎓</span>
          </h1>
          <div className="absolute left-0 right-0 bottom-0 h-px bg-gradient-to-r from-transparent via-purple-300 to-transparent"></div>
        </div>
        ...
        <div className="bg-purple-50 p-6 rounded-lg mb-8">
          <h2 className="text-xl font-bold text-purple-800 mb-4 text-right">الشروط والمتطلبات:</h2>
          <ol className="list-decimal list-inside space-y-4 text-gray-800 text-lg text-right">
            <li className="p-2 hover:bg-purple-100 rounded transition-colors duration-200">
        ...
        <div className="mb-8 text-right">
          <h2 className="text-xl font-bold text-purple-800 mb-4">مزايا المنحة:</h2>
        ...
        <div className="mt-8 text-center">
          <div className="p-4 bg-purple-100 rounded-lg border border-purple-200">
            ...
            <p className="text-gray-600 mt-2">
              ...
              <span className="font-semibold text-purple-700"> scholarships@example.org</span>
            </p>
          </div>
        </div>
      </div>
